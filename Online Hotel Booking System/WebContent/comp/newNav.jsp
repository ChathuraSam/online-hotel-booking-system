	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link"
				href="Owner-homepage.jsp">Owner Dashboard</a></li>
			<li class="nav-item"><a class="nav-link"
				href="Owner-updateViewHotels.jsp">View Hotel Reservations</a></li>
				<li class="nav-item"><a class="nav-link"
				href="Owner-addHotel.jsp">Add Hotel</a></li>
				<li class="nav-item"><a class="nav-link"
				href="Owner-addRoom.jsp">Add Rooms</a></li>
				<li class="nav-item"><a class="nav-link"
				href="Owner-updateViewHotels.jsp">View Hotel Reservations</a></li>
				<li class="nav-item"><a class="nav-link"
				href="Owner-updateViewHotels.jsp">View Hotel Reservations</a></li>
