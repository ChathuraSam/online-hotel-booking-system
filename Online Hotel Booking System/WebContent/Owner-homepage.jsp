<%@ page language="java" import="com.hcl.ohbs.entities.Hotel,com.hcl.ohbs.entities.Room,java.util.*" contentType="text/html; charset=ISO-8859-1"
...
<!--  <div class="container-xl">
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <% // retrieve your list from the request, with casting 
			//List<Hotel> list = (ArrayList<Hotel>) request.getAttribute("hotels");
            List<Room> roomList = (ArrayList<Room>) session.getAttribute("rooms");
            if(list!=null){ %>
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
            ...
            <%	}else{  %>
            <font color="red">You have not added any Rooms yet.</font>
           	<%	} %>
            <div class="clearfix">
                <div class="hint-text">Showing <b>5</b> out of <b>25</b> entries</div>
                <ul class="pagination">
